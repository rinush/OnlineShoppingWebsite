...
if (isset($_POST['a1'])) 
{
 $_SESSION['lm1']=$_POST['a1'];
 $_SESSION['lm1_id']='lm1';
 $_SESSION['lm1_price']=280;
 $_SESSION['lm1_num']=$_POST['num']; 
}
else if(isset($_POST['a2']))
{
 $_SESSION['lm1']='';
 $_SESSION['lm1_id']='';
 $_SESSION['lm1_price']=0;
 $_SESSION['lm1_num']=''; 
}
?>
...
<form action="" method="POST">
<img src="img/lm1.jpg" width="150px" style="float:left;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 200</span >
...
<input type="submit" value="Add To Cart" id="lm1" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
