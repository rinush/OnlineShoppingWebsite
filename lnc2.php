...
if (isset($_POST['a1'])) 
{
 $_SESSION['lnc2']=$_POST['a1'];
 $_SESSION['lnc2_id']='lnc2';
 $_SESSION['lnc2_price']=280;
 $_SESSION['lnc2_num']=$_POST['num']; 
}
else if(isset($_POST['a2']))
{
 $_SESSION['lnc2']='';
 $_SESSION['lnc2_id']='';
 $_SESSION['lnc2_price']=0;
 $_SESSION['lnc2_num']=''; 
}
?>
...
<form action="" method="POST">
<img src="img/lnc2.jpg" width="150px" style="float:left;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 200</span >
...
<input type="submit" value="Add To Cart" id="lnc2" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
