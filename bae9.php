...
if (isset($_POST['a1'])) 
{
 $_SESSION['bae9']=$_POST['a1'];
 $_SESSION['bae9_id']='bae9';
 $_SESSION['bae9_price']=650;
 $_SESSION['bae9_num']=$_POST['num']; 
}
...
<form action="" method="POST">
<img src="img/bae9.jpg" width="150px" style="float:left;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 650</span >
...
<input type="submit" value="Add To Cart" id="bae9" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
