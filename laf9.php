...
if (isset($_POST['a1'])) 
{
 $_SESSION['laf9']=$_POST['a1'];
 $_SESSION['laf9_id']='laf9';
 $_SESSION['laf9_price']=250;
 $_SESSION['laf9_num']=$_POST['num']; 
}
...
<form action="" method="POST">
<img src="img/laf9.jpg" width="150px" style="float:left; margin-top:200px;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 300</span >
...
<input type="submit" value="Add To Cart" id="laf9" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
