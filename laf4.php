...
if (isset($_POST['a1'])) 
{
 $_SESSION['laf4']=$_POST['a1'];
 $_SESSION['laf4_id']='laf4';
 $_SESSION['laf4_price']=100;
 $_SESSION['laf4_num']=$_POST['num']; 
}
...
<form action="" method="POST">
<img src="img/laf4.jpg" width="150px" style="float:left; margin-top:200px;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 300</span >
...
<input type="submit" value="Add To Cart" id="laf4" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
