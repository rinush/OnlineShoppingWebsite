...
if (isset($_POST['a1'])) 
{
 $_SESSION['romnc1']=$_POST['a1'];
 $_SESSION['romnc1_id']='romnc1';
 $_SESSION['romnc1_price']=110;
 $_SESSION['romnc1_num']=$_POST['num']; 
}
else if(isset($_POST['a2']))
{
 $_SESSION['romnc1']='';
 $_SESSION['romnc1_id']='';
 $_SESSION['romnc1_price']='';
 $_SESSION['romnc1_num']=''; 
}
?>
...
<form action="" method="POST">
<img src="img/romnc1.jpg" width="150px" style="float:left; margin-top:200px;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 300</span >
...
<input type="submit" value="Add To Cart" id="romnc1" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
