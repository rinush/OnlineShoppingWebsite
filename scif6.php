...
if (isset($_POST['a1'])) 
{
 $_SESSION['scif6']=$_POST['a1'];
 $_SESSION['scif6_id']='scif6';
 $_SESSION['scif6_price']=280;
 $_SESSION['scif6_num']=$_POST['num']; 
}
else if(isset($_POST['a2']))
{
 $_SESSION['scif6']='';
 $_SESSION['scif6_id']='';
 $_SESSION['scif6_price']=0;
 $_SESSION['scif6_num']=''; 
}
?>
...
<form action="" method="POST">
<img src="img/scif6.jpg" width="150px" style="float:left;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 200</span >
...
<input type="submit" value="Add To Cart" id="scif6" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
