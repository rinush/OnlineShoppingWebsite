...
if (isset($_POST['a1'])) 
{
 $_SESSION['bae7']=$_POST['a1'];
 $_SESSION['bae7_id']='bae7';
 $_SESSION['bae7_price']=225;
 $_SESSION['bae7_num']=$_POST['num']; 
}
...
<form action="" method="POST">
<img src="img/bae7.jpg" width="150px" style="float:left;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 225</span >
...
<input type="submit" value="Add To Cart" id="bae7" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
