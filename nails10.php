...
if (isset($_POST['a1'])) 
{
 $_SESSION['nails10']=$_POST['a1'];
 $_SESSION['nails10_id']='nails10';
 $_SESSION['nails10_price']=280;
 $_SESSION['nails10_num']=$_POST['num']; 
}
else if(isset($_POST['a2']))
{
 $_SESSION['nails10']='';
 $_SESSION['nails10_id']='';
 $_SESSION['nails10_price']=0;
 $_SESSION['nails10_num']=''; 
}
?>
...
<form action="" method="POST">
<img src="img/nails10.jpg" width="150px" style="float:left;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 200</span >
...
<input type="submit" value="Add To Cart" id="nails10" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
