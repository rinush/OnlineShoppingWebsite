...
if (isset($_POST['a1'])) 
{
 $_SESSION['cat1']=$_POST['a1'];
 $_SESSION['cat1_id']='cat1';
 $_SESSION['cat1_price']=280;
 $_SESSION['cat1_num']=$_POST['num']; 
}
else if(isset($_POST['a2']))
{
 $_SESSION['cat1']='';
 $_SESSION['cat1_id']='';
 $_SESSION['cat1_price']=0;
 $_SESSION['cat1_num']=''; 
}
?>
...
<form action="" method="POST">
<img src="img/cat1.jpg" width="150px" style="float:left;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 200</span >
...
<input type="submit" value="Add To Cart" id="cat1" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
