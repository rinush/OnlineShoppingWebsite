...
if (isset($_POST['a1'])) 
{
 $_SESSION['romnc6']=$_POST['a1'];
 $_SESSION['romnc6_id']='romnc6';
 $_SESSION['romnc6_price']=225;
 $_SESSION['romnc6_num']=$_POST['num']; 
}
else if(isset($_POST['a2']))
{
 $_SESSION['romnc6']='';
 $_SESSION['romnc6_id']='';
 $_SESSION['romnc6_price']='';
 $_SESSION['romnc6_num']=''; 
}
?>
...
<form action="" method="POST">
<img src="img/romnc6.jpg" width="150px" style="float:left; margin-top:200px;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 300</span >
...
<input type="submit" value="Add To Cart" id="romnc6" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
