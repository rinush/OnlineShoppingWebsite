...
if (isset($_POST['a1'])) 
{
 $_SESSION['romnc3']=$_POST['a1'];
 $_SESSION['romnc3_id']='romnc3';
 $_SESSION['romnc3_price']=320;
 $_SESSION['romnc3_num']=$_POST['num']; 
}
else if(isset($_POST['a2']))
{
 $_SESSION['romnc3']='';
 $_SESSION['romnc3_id']='';
 $_SESSION['romnc3_price']='';
 $_SESSION['romnc3_num']=''; 
}
?>
...
<form action="" method="POST">
<img src="img/romnc3.jpg" width="150px" style="float:left; margin-top:200px;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 300</span >
...
<input type="submit" value="Add To Cart" id="romnc3" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
