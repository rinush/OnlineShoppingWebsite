...
if (isset($_POST['a1'])) 
{
 $_SESSION['lips8']=$_POST['a1'];
 $_SESSION['lips8_id']='lips8';
 $_SESSION['lips8_price']=280;
 $_SESSION['lips8_num']=$_POST['num']; 
}
else if(isset($_POST['a2']))
{
 $_SESSION['lips8']='';
 $_SESSION['lips8_id']='';
 $_SESSION['lips8_price']=0;
 $_SESSION['lips8_num']=''; 
}
?>
...
<form action="" method="POST">
<img src="img/lips8.jpg" width="150px" style="float:left;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 200</span >
...
<input type="submit" value="Add To Cart" id="lips8" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
