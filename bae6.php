...
if (isset($_POST['a1'])) 
{
 $_SESSION['bae6']=$_POST['a1'];
 $_SESSION['bae6_id']='bae6';
 $_SESSION['bae6_price']=450;
 $_SESSION['bae6_num']=$_POST['num']; 
}
...
<form action="" method="POST">
<img src="img/bae6.jpg" width="150px" style="float:left;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 450</span >
...
<input type="submit" value="Add To Cart" id="bae6" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
