...
if (isset($_POST['a1'])) 
{
 $_SESSION['bae3']=$_POST['a1'];
 $_SESSION['bae3_id']='bae3';
 $_SESSION['bae3_price']=400;
 $_SESSION['bae3_num']=$_POST['num']; 
}
...
<form action="" method="POST">
<img src="img/bae3.jpg" width="150px" style="float:left;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 400</span>
...
<input type="submit" value="Add To Cart" id="bae3" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
