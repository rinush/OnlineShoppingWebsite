...
if (isset($_POST['a1'])) 
{
 $_SESSION['bae4']=$_POST['a1'];
 $_SESSION['bae4_id']='bae4';
 $_SESSION['bae4_price']=250;
 $_SESSION['bae4_num']=$_POST['num']; 
}
...
<form action="" method="POST">
<img src="img/bae4.jpg" width="150px" style="float:left;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 250</span >
...
<input type="submit" value="Add To Cart" id="bae4" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
