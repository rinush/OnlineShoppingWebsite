...
if (isset($_POST['a1'])) 
{
 $_SESSION['bam8']=$_POST['a1'];
 $_SESSION['bam8_id']='bam8';
 $_SESSION['bam8_price']=280;
 $_SESSION['bam8_num']=$_POST['num']; 
}
else if(isset($_POST['a2']))
{
 $_SESSION['bam8']='';
 $_SESSION['bam8_id']='';
 $_SESSION['bam8_price']=0;
 $_SESSION['bam8_num']=''; 
}
?>
...
<form action="" method="POST">
<img src="img/bam8.jpg" width="150px" style="float:left;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 200</span >
...
<input type="submit" value="Add To Cart" id="bam8" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
