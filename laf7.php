...
if (isset($_POST['a1'])) 
{
 $_SESSION['laf7']=$_POST['a1'];
 $_SESSION['laf7_id']='laf7';
 $_SESSION['laf7_price']=400;
 $_SESSION['laf7_num']=$_POST['num']; 
}
...
<form action="" method="POST">
<img src="img/laf7.jpg" width="150px" style="float:left; margin-top:200px;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 300</span >
...
<input type="submit" value="Add To Cart" id="laf7" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
