...
if (isset($_POST['a1'])) 
{
 $_SESSION['bae5']=$_POST['a1'];
 $_SESSION['bae5_id']='bae5';
 $_SESSION['bae5_price']=350;
 $_SESSION['bae5_num']=$_POST['num']; 
}
...
<form action="" method="POST">
<img src="img/bae5.jpg" width="150px" style="float:left;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 350</span >
...
<input type="submit" value="Add To Cart" id="bae5" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
