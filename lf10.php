...
if (isset($_POST['a1'])) 
{
 $_SESSION['lf10']=$_POST['a1'];
 $_SESSION['lf10_id']='lf10';
 $_SESSION['lf10_price']=280;
 $_SESSION['lf10_num']=$_POST['num']; 
}
else if(isset($_POST['a2']))
{
 $_SESSION['lf10']='';
 $_SESSION['lf10_id']='';
 $_SESSION['lf10_price']=0;
 $_SESSION['lf10_num']=''; 
}
?>
...
<form action="" method="POST">
<img src="img/lf10.jpg" width="150px" style="float:left;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 200</span >
...
<input type="submit" value="Add To Cart" id="lf10" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
