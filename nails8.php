...
if (isset($_POST['a1'])) 
{
 $_SESSION['nails8']=$_POST['a1'];
 $_SESSION['nails8_id']='nails8';
 $_SESSION['nails8_price']=280;
 $_SESSION['nails8_num']=$_POST['num']; 
}
else if(isset($_POST['a2']))
{
 $_SESSION['nails8']='';
 $_SESSION['nails8_id']='';
 $_SESSION['nails8_price']=0;
 $_SESSION['nails8_num']=''; 
}
?>
...
<form action="" method="POST">
<img src="img/nails8.jpg" width="150px" style="float:left;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 200</span >
...
<input type="submit" value="Add To Cart" id="nails8" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
