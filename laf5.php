...
if (isset($_POST['a1'])) 
{
 $_SESSION['laf5']=$_POST['a1'];
 $_SESSION['laf5_id']='laf5';
 $_SESSION['laf5_price']=450;
 $_SESSION['laf5_num']=$_POST['num']; 
}
...
<form action="" method="POST">
<img src="img/laf5.jpg" width="150px" style="float:left; margin-top:200px;"><span style="font-size:30px; float:left; margin-left:100px; margin-top:40px; color:blue;">Price: Rs 300</span >
...
<input type="submit" value="Add To Cart" id="laf5" name="a1" style="width:200px; border-radius:5px; height:50px;font-size:24px; margin-top:100px; float:left; margin-left:100px;">
